...
It took about a month to get the laptop shipped, which seems long but I was fine with (as the laptop had to be built in China, shipped overseas during a pandemic).
...
The laptop also has a USB-C port, which I tested with a Dell docking station.
Everything worked out of the box with Linux (power delivery, USB devices and video).
